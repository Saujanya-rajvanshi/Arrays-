...
- [find second smallest largest ](#second-smallest-and-largest) <a href="https://leetcode.com/problems/kth-largest-element-in-an-array/" target="_blank">Lc</a> -[kth element](https://leetcode.com/problems/kth-largest-element-in-an-array/)  -[dryrun](https://chatgpt.com/s/t_6a7eedf1a38481919b7544e1b097fc1a)
...
- [left rotate upto d index](#left-rotate-upto-d-index)  -[lc](https://leetcode.com/problems/rotate-array/description/)
- [shift zeros to the last](#shift-zeros-to-the-last)   -[lc](https://leetcode.com/problems/move-zeroes/description/)
- [linear search](#linear-search)  
- [union array of two sorted array](#union-array-of-two-sorted-array)  -[lc](https://leetcode.com/problems/merge-two-sorted-lists/description/)
- [intersection of array](#intersection-of-array)  -[lc](https://leetcode.com/problems/intersection-of-two-arrays/description/)
- [find missing number](#find-missing-number)  -[lc](https://leetcode.com/problems/missing-number/description/)
- [maximum no. of consecutive ones](#maximum-no-of-consecutive-ones)  
- [find single number](#find-single-number) -[lc1](https://leetcode.com/problems/single-number/description/) -[lc2](https://leetcode.com/problems/single-number-ii) -[lc3](https://leetcode.com/problems/single-number-iii/description/) 
- [longest subarray with sum k](#longest-subarray-with-sum-k)

#### MEDIUM 
- [two sum](#two-sum) -[lc](https://leetcode.com/problems/two-sum/description/)
- [sort an array of 0's 1's and 2's](#sort-an-array-of-zeroes-ones-twoes)  
- [majority element(>n/2 times)](#majority-element-greater-than-n-by-two-times)  -[lc1](https://leetcode.com/problems/majority-element/description/)  -[lc2](https://leetcode.com/problems/majority-element-ii/)
- [kadanes algorithm maximum subarray sum](#kadanes-algorithm-maximum-subarray-sum)  -[lc](https://leetcode.com/search/?q=maximum+subarray+sum)
- [print subarray with maximum subarray sum (extended version of above problem)](#print-subarray-with-maximum-subarray-sum)  -[lc](https://leetcode.com/search/?q=subarray+with+maximum+subarray+sum)
- [stock buy and sell](#stock-by-and-sell)  -[lc](https://leetcode.com/search/?q=stock+buy+and+sell)
